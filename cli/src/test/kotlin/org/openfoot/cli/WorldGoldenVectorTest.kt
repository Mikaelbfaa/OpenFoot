 ...
 *
 * The dataset, GoldenWorld.dataset, is written in code for these tests alone: two countries,
...
class WorldGoldenVectorTest {
    ...
    fun `the fixture world summarises exactly as pinned`() {
        val world = generateWorld(GoldenWorld.dataset, seed = 42L, activeLeagues = setOf(GoldenWorld.fixCountry.index))
        assertEquals(
            """
            seed      42
            clubs     12
